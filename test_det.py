...
cfg.MODEL.WEIGHTS = os.path.join("C:/Users/Danielle/Desktop/stage_N3/dataset/output2/", "model_final.pth")
...
cfg.MODEL.DEVICE = "cpu"
cfg.OUTPUT_DIR = "C:/Users/Danielle/Desktop/stage_N3/dataset/output2"  # Repertoire

DATASET_ROOT = "C:/Users/Danielle/Desktop/stage_N3/dataset/split_data2"

TRAIN_JSON = "C:/Users/Danielle/Desktop/stage_N3/dataset/split_data2/train/train2_coco.json"
TRAIN_IMG= "C:/Users/Danielle/Desktop/stage_N3/dataset/split_data2/train/images"

VAL_JSON = "C:/Users/Danielle/Desktop/stage_N3/dataset/split_data2/val/val2_coco.json"
VAL_IMG = "C:/Users/Danielle/Desktop/stage_N3/dataset/split_data/val2/images"
CLASS_NAMES = ["Helice manquante/cassee", "Camera cassee", "Corps principal defectueux", "Pieds de support endommagés", "Drone detruit", "Batterie cassee/manquante"] #Les classes a afficher

DatasetCatalog.register("drone_defect_train", lambda: DatasetCatalog(os.path.join(DATASET_ROOT, TRAIN_JSON), os.path.join(DATASET_ROOT, TRAIN_IMG))) #Load Train
MetadataCatalog.get("drone_defect_train").set(thing_classes=CLASS_NAMES) #Name

DatasetCatalog.register("drone_defect_val", lambda: DatasetCatalog(os.path.join(DATASET_ROOT, VAL_JSON), os.path.join(DATASET_ROOT, VAL_IMG))) #Load Train
MetadataCatalog.get("drone_defect_val").set(thing_classes=CLASS_NAMES) #Name
#Load et appliquer des infos sur le TRAIN DATA, ce qui facilite la génération futur et d'avoir des problèmes.

metadata = MetadataCatalog.get("drone_defect_train") #Load en mémoire
...
# Charger l'image:
image_path = "C:/Users/Danielle/Desktop/stage_N3/test2.jpg" #Modifier avec chemin
...
resized_img = out.get_image()[:, :, ::-1]  # Initialisation de resized_img
